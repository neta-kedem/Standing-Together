...
constructor(props) {
	super(props);
	this.state = {query: {/*"profile.firstName":"Noam"*/},
		events: [],activists: [], currFilters: [], allSelected: false,
		tableFields:[
...
componentDidMount() {
	...
	componentWillUpdate(nextProps, nextState){
		if(nextState.activists !== this.state.activists){
			this.setState({activists: nextState.activists})
		}
	...
	_removeFilter(groupId, filterId){
		ItemService.removeSingleFilter(groupId, filterId)
			.then((currFilters) => this.setState({currFilters}))
	}
	_newFilter(query){
		this.setState({query});
				...
				<div className="page-wrap">
					...
					<div className="wrapper">
						<div className="left-panel">
							<QueryCreator currFilters={this.state.currFilters} onRemoveFilter={this._removeFilter.bind(this)} newFilter={this._newFilter.bind(this)}></QueryCreator>
						</div>
